function addExamples (styleName, lang, dir, type) {
    ...
    var out = ''
    out += `<p class="browser_output_title">在浏览器中预览<a style="float:right" href="https://developer.mozilla.org/en-US/docs/Web/CSS/list-style-type#browser_compatibility" target="_blank"><img src="compat.svg" alt="检查浏览器内置支持情况" title="检查浏览器内置支持情况"></a></p>`
